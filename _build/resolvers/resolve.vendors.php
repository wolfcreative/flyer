...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    ...
    case xPDOTransport::ACTION_UPGRADE:
        ...
        $cacheManager->deleteTree(MODX_ASSETS_PATH . 'components/flyer/vendor/',
        ...
        $vendors = array(
            array(
                ...
                MODX_ASSETS_PATH . 'components/flyer/vendor/'
            ),
            array(
                'icy_orange',
                'icy_orange',
                'https://download.ckeditor.com/icy_orange/releases/icy_orange_0.9.zip',
                MODX_ASSETS_PATH . 'components/flyer/vendor/skins/'
            ),
            array(
                'codemirror',
                'codemirror',
                'https://github.com/w8tcha/CKEditor-CodeMirror-Plugin/archive/master.zip',
                MODX_ASSETS_PATH . 'components/flyer/vendor/plugins/'
            ),
            array(
                'devtags',
                'devtags',
