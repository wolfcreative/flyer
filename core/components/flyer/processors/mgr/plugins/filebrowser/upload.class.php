...
class flyerFileBrowserUploadProcessor extends modProcessor
{
    /** @var flyer $flyer */
    public $flyer;
    ...
    public function initialize()
    {
        ...
        $this->flyer = $this->modx->getService('flyer');
        $this->flyer->initialize($this->getProperty('wctx'));
    ...
    {
        $value = $this->flyer->getOption('source_fileName', null, '{name}.{ext}', true);
        if (!empty($this->source)) {
            $value = $this->flyer->getOption('fileName', $this->source->properties, $value, true);
        }
    ...
    {
        $value = $this->flyer->getOption('source_filePath', null, '{class_key}/{id}/', true);
        if (!empty($this->source)) {
            $value = $this->flyer->getOption('filePath', $this->source->properties, $value, true);
        }
    ...
    {
        $value = $this->flyer->getOption('source_fileNameType', null, 'friendly', true);
        if (!empty($this->source)) {
            $value = $this->flyer->getOption('fileNameType', $this->source->properties, $value, true);
        }
...
return 'flyerFileBrowserUploadProcessor';